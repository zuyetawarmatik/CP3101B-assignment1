...
var pagesContent = {
	...
	task_edit: {
		title: "Edit Task",
		mainContent: "<form method='POST' action='service/task/edit.php' id='task-edit-form'>\
						<table>\
							<tr>\
								<td>\
									<label for='name'>Name</label>\
							...
							<tr>\
								<td colspan='2'>\
									<div>\
										<a class='button' href='' id='task-revert-btn'>Revert work unit</a>\
										<input type='submit' value='Save'>\
									</div>\
								</td>\
							</tr>\
