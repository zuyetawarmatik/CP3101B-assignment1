		...
		success: function(response) {
			$.each(response, function(i, task){
				var $taskLi = $("<li data-task-id='" + task.id + "'>\
									<a href='' data-to='task_edit/" + task.id + "'><h2>Task name here</h2></a>\
