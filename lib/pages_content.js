...
var pagesContent = {
	...
	profile: {
		title: "Profile",
		mainContent: "<form method='POST' action=''>\
						<table>\
							<tr>\
								<td>\
									<label for='username'>Username</label>\
	...
	tasks: {
		...
		extraContent: "<section id='title-section'>\
							<div id='title-section-content'>\
								<div id='title-box'>\
									<h1><span style='font-weight: 700'>'s</span> to-do list</h1>\
								</div>\
								<div id='btn-box'>\
									<a class='button' href='' data-to='task_edit'>Add new task</a>\
								</div>\
							</div>\
						</section>",
	...
	task_create: {
		title: "Create Task",
		mainContent: "<form method='POST' action='service/tasks/add.php'>\
						<table>\
							<tr>\
								<td>\
	...
	task_edit: {
		title: "Edit Task",
		mainContent: "<form method='POST' action='service/tasks/edit.php'>\
						<table>\
							<tr>\
								<td>\
									<label for='name'>Name</label>\
